...
export default function Estimates() {
  ...
  const { currentPage, totalPages, totalItems, itemsPerPage, paginatedItems: rawPaginatedItems, goToPage } = usePagination<Quote>(filteredQuotes, 10);
  const displayQuotes = (rawPaginatedItems || []) as Quote[];
