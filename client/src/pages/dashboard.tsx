          ...
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <Link href="/customers">
                  <Button variant="outline" className="h-auto p-4 flex flex-col items-center justify-center gap-1 hover:border-indigo-300 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/50 transition-colors w-full" data-testid="button-guide-customers">
                    <p className="font-medium">1. Add Customers</p>
                    <p className="text-xs text-muted-foreground">Create your customer list</p>
                  </Button>
                </Link>
                <Link href="/invoices/new">
                  <Button variant="outline" className="h-auto p-4 flex flex-col items-center justify-center gap-1 hover:border-indigo-300 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/50 transition-colors w-full" data-testid="button-guide-invoice">
                    <p className="font-medium">2. Create Invoice</p>
                    <p className="text-xs text-muted-foreground">Send your first invoice</p>
                  </Button>
                </Link>
                <Link href="/expenses">
                  <Button variant="outline" className="h-auto p-4 flex flex-col items-center justify-center gap-1 hover:border-indigo-300 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/50 transition-colors w-full" data-testid="button-guide-expenses">
